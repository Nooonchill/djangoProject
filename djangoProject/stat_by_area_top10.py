...
salary_avg_area_prof_for_graph = (stat_by_area[stat_by_area['vacancies_percent'] > 0.01]
                             ...
                             [['salary_avg_prof']]
                             .head(10))
#salary_avg_area_for_graph.to_sql('vacancies_stat_salaryavgareaproftop10', conn, if_exists='append')
...
vacancies_percent_area_for_graph = (stat_by_area[stat_by_area['vacancies_percent'] > 0.01]
                                    ...
                                    .head(10))
vacancies_percent_area_for_graph.loc['Другие'] = 1- sum(vacancies_percent_area_for_graph['vacancies_percent'].values)
#salary_avg_area_for_graph.to_sql('vacancies_stat_vacanciespercentareatop10', conn, if_exists='append')
...
#salary_avg_area_for_graph.to_sql('vacancies_stat_vacanciespercentareaproftop10', conn, if_exists='append')
